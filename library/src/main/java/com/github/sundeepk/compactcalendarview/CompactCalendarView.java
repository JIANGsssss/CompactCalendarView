...
public class CompactCalendarView extends View {
    ...
    private OnRightScrollLimitListener limitListener;
    ...
    public void setOnRightScrollLimitListener(OnRightScrollLimitListener limitListener) {
    ...
    private final GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (limitListener.isThisMonth() && distanceX > 0) {
    ...
    public interface OnRightScrollLimitListener {
